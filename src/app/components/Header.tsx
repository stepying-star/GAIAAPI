          ...
          <div className="px-6 pb-8">
            ...
            {authModal === 'login' && (
              <form onSubmit={handleLogin} className="space-y-4">
                ...
                <button
                  type="button"
                  className="w-full h-11 bg-gray-50 dark:bg-gray-800 text-gray-900 dark:text-white font-medium rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors flex items-center justify-center gap-2 border border-gray-200 dark:border-gray-700"
                >
